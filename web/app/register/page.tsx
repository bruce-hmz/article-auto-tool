...
export default function RegisterPage() {
 ...
 cn(
 "appearance-none relative block w-full px-3 py-2.5 border placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white dark:bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:z-10",
 ...
 <Link href="/login" className="text-primary hover:text-primary/80 dark:text-primary font-medium">
 Sign in
 </Link>
 </p>
 </div>
