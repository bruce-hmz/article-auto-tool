...
export default function RegisterPage() {
  ...
  const inputClass = (hasError?: string) =>
    cn(
      "block w-full px-3 py-2.5 border bg-background text-sm font-mono focus:outline-none focus:ring-2 focus:ring-ring",
            ...
            {password && (
              <div className="mt-2">
                <div className="h-1 w-full bg-muted overflow-hidden">
                  <div className={cn('h-full transition-all', strength.color, strength.width)} />
                </div>
                <p className="text-xs text-muted-foreground font-mono mt-1">{strength.label}</p>
              </div>
            )}
          </div>

          <div>
            <label htmlFor="confirm-password" className="block text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5">
              Confirm password *
            </label>
            <input
              id="confirm-password"
